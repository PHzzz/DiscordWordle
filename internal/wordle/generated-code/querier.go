...
type Querier interface {
	...
	GetExpectedPreviousWeekGames(ctx context.Context, serverID string) ([]time.Time, error)
	GetExpectedWeekGames(ctx context.Context, serverID string) ([]time.Time, error)
